...
`S5.5 — Implement R0/R1 promotion, GitHub auto-merge, and demotion`
...
| S5.5 | Implement R0/R1 promotion, GitHub auto-merge, and demotion | AWAITING_REVIEW | RED→GREEN: 3 github-auto-merge tests; eligible promoted R0/R1 work enables GitHub auto-merge and never an agent merge; R2/R3 and live exceptions stay `human_merge`; trust-boundary failure, severity-1/2 escape, two unreplayed escapes, or flake above 15% disable auto-merge; full `npm run check` with 179 tests; exact 97-artifact installed package | `GR-20260903-S5.5-R1`; pending commit |
